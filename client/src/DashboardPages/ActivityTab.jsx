...
const ActivityTab = () => {
  ...
  const handleExport = () => {
    ...
    const filename = `activities-${datePart} ${timePart}.csv`;
            ...
            <table className="min-w-full bg-white dark:bg-gray-800">
              ...
              <tbody>
                {paginated.map((act) => (
                  ...
                  >
                    <td className="px-6 py-3">{act.title}</td>
                    <td className="px-6 py-3">{act.description}</td>
                    <td className="px-6 py-3">
                      {formatDateForInput(act.date)}
                    </td>
                    <td className="px-6 py-3">{act.location}</td>
                    <td className="px-6 py-3">{act.organizer}</td>
